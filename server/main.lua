	...
	if found then
		...
		elseif (givenItem ~= nil) and (#givenItem > 0) then
			...
			if givenMsg ~= "" then
				...
				--[[for k in ipairs(givenItem) do
					TriggerEvent('vorp:ShowAdvancedRightNotification', Config.SkinnableAnimals[model].name,"inventory_items", k , "COLOR_PURE_WHITE", 4000)
